...
| ListPicker | A modal that opens up to allow the user to select a string from a list of strings |
| LongString | A large textbox for a multiline string |
