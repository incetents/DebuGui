...
-- Public API --
----------------
function GizmoNumberSlider.new(Gui, UniqueName, ParentAPI, DefaultValue, MinValue, MaxValue, DecimalAmount, UpdateOnlyOnDragEnd)
	...
	ValueDragger.OnDrag(function()
		...
		if DecimalAmount then
			local Mod = (10 ^ DecimalAmount)
			NewValue = math.round(NewValue * Mod) / Mod
		end
